...
extension AuthViewController: ASAuthorizationControllerDelegate,
    ...
    func authorizationController(controller: ASAuthorizationController,
        ...
        print("FullName: \(appleIDCredential.fullName?.givenName)")
        ...
        Auth.auth().signIn(with: credential) { result, error in
            ...
            AuthViewModel.shared.transitionFromAppleViewController(result: result, name: (appleIDCredential.fullName?.givenName ?? "") + " " + (appleIDCredential.fullName?.familyName ?? ""))
